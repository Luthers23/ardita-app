...
import MyArchiveColumnShape from "page-sections/archive/MyArchiveColumnShape";
  ...
  useEffect(() => {
    const fetchArchives = async () => {
      ...
      try {
        ...
        const response = await axios.get(`${url}/api/archives/user`);
  ...
  return (
    <Box pt={2} pb={4}>
      ...
      {loading ? (
        ...
        <CustomTable columnShape={MyArchiveColumnShape} data={filteredItem} />
      ) : (
